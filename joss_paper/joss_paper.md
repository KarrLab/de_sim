...
\label{fig:comparison}](comparison.png)
...
DE-Sim requires [Python](https://www.python.org/) 3.7 or higher and [pip](https://pip.pypa.io/). This article discusses version 0.1.7 of DE-Sim.
